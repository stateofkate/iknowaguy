...
def priceDiscoverySystemPrompt(SKU: str, lowerPrice: str, higherPrice: str, quantity: str, date: str) -> str:
    prompt = (f"You are an assistant that is looking to purchase {quantity} of products with SKU {SKU} "
...
def placeOrderSystemPrompt(SKU: str, price: str, quantity: str, date: str) -> str:
    prompt = (f"You are an assistant that is looking to purchase {quantity} of products with SKU {SKU} at {price} price. "
